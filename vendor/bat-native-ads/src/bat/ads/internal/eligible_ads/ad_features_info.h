...
#ifndef BRAVE_VENDOR_BAT_NATIVE_ADS_SRC_BAT_ADS_INTERNAL_ELIGIBLE_ADS_AD_FEATURES_INFO
#define BRAVE_VENDOR_BAT_NATIVE_ADS_SRC_BAT_ADS_INTERNAL_ELIGIBLE_ADS_AD_FEATURES_INFO
...
struct AdFeaturesInfo {
  ...
  T creative_ad;  // TODO(Moritz Haller): slicing won't work bc of return val for `SampleAd(ads)`
...
#endif  // BRAVE_VENDOR_BAT_NATIVE_ADS_SRC_BAT_ADS_INTERNAL_ELIGIBLE_ADS_AD_FEATURES_INFO
